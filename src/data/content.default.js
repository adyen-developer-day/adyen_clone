// Default content — mirrors the live Adyen homepage copy (localhost demo only).
...
const content = {
  ...
  industries: {
    ...
    note: "Built for the way you do business.",
    linkLabel: "See more",
    items: [
      {
        title: "Retail",
  ...
  footer: {
    tagline: "One platform for payments, data, and financial products.",
